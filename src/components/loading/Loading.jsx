...
const DelayedRedirect = () => {
  ...
  useEffect(() => {
    if (redirect) {
      // Здесь вы можете установить путь к вашей странице подтверждения мэйла
      navigate('/confirm-registration');
    }
  }, [redirect, navigate]);

  return (
    <div className='' style={{ textAlign: 'center',color:"red" }}><h1>ברוכים הבאים! אנו שולחים לך קוד אימות למייל שלך.
    </h1>
    <div className="scene">
